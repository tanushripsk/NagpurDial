  ...
  return (
    <div className="container">
      <div className="container-fluid p-10">
        ...
        <h5>
          <strong>Vocational Training in Nagpur</strong>
        </h5>
        <div style={{ padding: "2px" }}></div>
        {/* <!-- client-1 --> */}
        <div style={{ padding: "2px" }}></div>
          ...
          <div className="row">
            ...
            <div className="col-lg-8">
              <h5 className="bp mt-1">
                <b>Prime Exotica Salon Nagpur</b>
              </h5>
              <p>ETERNITY MALL, Sitabuldi, Nagpur, Maharashtra 440010</p>

              <p>
                Get pampered by professionals beauty services, also Get Complete
                Hair Services From Haircut, Hair Color To Hair Treatment
              </p>
              <i
        ...
        <div className="beauty">
          <div className="row">
            ...
            <div className="col-lg-8">
              <h5 className="bp mt-1">
                <b>Amit Higher English Primary School</b>
              </h5>
              <p>444M+P36, 189, Kirti Nagar, Dighori, Nagpur, Maharashtra 440034</p>

              <p>
              Amit Higher English Pri. School, Narsada Road was established in 2003 and it is managed by the Pvt. Unaided. It is located in Urban area. It is located in URC 1 block of Nagpur district of Maharashtra.
              </p>
              <i
                className="fa fa-star"
                style={{ fontSize: "26px", color: "#FFC300" }}
