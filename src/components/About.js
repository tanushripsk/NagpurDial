        ...
        <div className="row">
          <div className="col-lg-8">
            ...
            <p style={{ textAlign: "justify", fontSize: "13px" }}>
              ...
              Search engine <b>(नागपुर का अपना लोकल सर्च इंजन)</b> it provides
              local search related services to users and it helps to connect
              business to business within Nagpur. through website & mobile App
              (Android Web View). PSK Technologies Motive is to give fast
              services to connect users to businesses and Business to Business
            </p>
            ...
            <p style={{ textAlign: "justify", fontSize: "13px" }}>
              ...
              our users and enable discovery and transactions for all products
              and services.
            </p>
            <h5>
            ...
            <p style={{ textAlign: "justify", fontSize: "13px" }}>
              ...
              Computing Computer and Network Security, Programming, C, C++,
              JAVA, PHP, My-SQL, Information or Network Security, Database,
              Operating systems, Soft-skills, UI Development. Also we are in the
              field of E-commerce, Website Designing & Development, Digital
              Marketing like SEO, SMM, SEM, Email Marketing, Android App
              Development, Domain Registrations & Hosting. We are well known as
              the No. 1 IT Services Provider in Nagpur Maharashtra, Digital
              Marketing And Website Development | Computer Sales & Services & IT
              Training etc.
            </p>
          </div>
          <div className="col-lg-4">
            <small>
              <b>
                For more details on Nagpurdial's performances you may check:
              </b>
            </small>
            <div>
              {" "}
